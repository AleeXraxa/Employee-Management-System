...
class _UpdateTaskState extends State<UpdateTask> {
  ...
  void initState() {
    ...
    _taskController.titleController.text = task.title;
    _taskController.startController.text = timeParts[0];
    _taskController.endController.text = timeParts[1];
    _taskController.locationController.text = task.location;
    _taskController.statusController.text = task.status;
